...
p3="mkpart linux ext3 500MB 200GB"            # create a linux partition #3
p4="mkpart swap linux-swap 200GB 208GB"       # create a linux partition #4
p5="mkpart linux ext3 208GB 220GB"            # create a linux partition #5
p6="mkpart linux ext3 220GB 100%"             # partition remaining disk space as linux partition #6
